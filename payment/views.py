...
def checkout(request):
    ...
    if request.user.is_authenticated:
        ...
        try:
            # Authentication users WITH shipping information
            ...
            # Authentication users with NO shipping information
...
def complete_order(request):
    ...
    if request.POST.get('action') == 'post':
        ...
        '''
            ...
            1) Create order -> Account user WITH + WITHOUT sipping information
        ...
        if request.user.is_authenticated:
            ...
            send_mail('Order received', 'Hi! ' + '\n\n' + 'Thank you for placing your order' + '\n\n' +
                      ...
                      str(cart.get_total()) + 'CHF', settings.EMAIL_HOST_USER, [email], fail_silently=False,)
